...
from db_functions import convert_db_info_to_dict_graphreduce
...
class GraphReduceData(object):
    ...
    def __init__(self, mode, case, case_id):
        ...
        #f.close()
        self.caseconfig = convert_db_info_to_dict_graphreduce(case_id)
        # Get scenarios
...
def reducegraph(mode, case, case_id, writeoutput):
    graphreducedata = GraphReduceData(mode, case, case_id)
